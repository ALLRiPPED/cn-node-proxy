	...
	var jsonServer = http.createServer((req, res) => {
		if (global.config.httpUser && global.config.httpPass) {
			...
			if (!auth) {
				...
				res.end('<html><body>Unauthorized CNP access.</body></html>');
				return;
			}
      ...
      let stylesheet = `body,html{font-family:'Saira Semi Condensed',sans-serif;font-size:14px;text-align:center}.light{color:#000;background-color:#fff}.dark{color:#0f0;background-color:#000}.header{-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;user-select:none;o-user-select:none;cursor:hand}.sorted-table{margin:auto;width:95%;text-align:center}.sorted-table td,.sorted-table th{border-bottom:1px solid #d9d9d9}.hover{background-color:#122710;cursor:pointer}.tooltip{position:relative;display:inline-block;border-bottom:1px dotted #000}.tooltip .tooltiptext{visibility:hidden;width:140px;background-color:#000;color:#fff;text-align:center;padding:5px 0;border-radius:6px;position:absolute;z-index:1;bottom:125%;left:50%;margin-left:-70px;opacity:0;transition:opacity .3s}.tooltip .tooltiptext::after{content:"";position:absolute;top:100%;left:50%;margin-left:-5px;border-width:5px;border-style:solid;border-color:#000 transparent transparent}.tooltip:hover .tooltiptext{visibility:visible;opacity:1}a:link,a:visited,a:hover,a:active{color:inherit;text-decoration:none;text-shadow: 0px 0px 5px #40c4ff;}`;
      ...
      res.writeHead(200, {'Content-type':'text/html'});
			res.write(`
<html lang="en"><head>
	<title>CNP v${PROXY_VERSION} Hashrate Monitor</title>
	<meta charset="utf-8">
  ...
  <link rel="icon" sizes="192x192" href="${icon}">
    ...
    <div title="Toggle theme..."  onclick="theme(body)"><h1 class="header" unselectable="on" onselectstart="return false;" onmousedown="return false;">CNP v${PROXY_VERSION} Hashrate Monitor</h1></div>
    <div id="content">
